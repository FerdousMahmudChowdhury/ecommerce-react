    ...
    <div>
      <div className='bg-white mx-auto mt-12 max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          <h1 className="my-5 text-4xl font-bold tracking-tight text-gray-900">Name: {userInfo.name ? userInfo.name : 'New User'}</h1>
          <h3 className="my-5 text-xl font-bold tracking-tight text-red-900">Email Address : {userInfo.email} </h3>
          {userInfo.role === 'admin' && <h3 className="my-5 text-xl font-bold tracking-tight text-red-900">role: {userInfo.role} </h3>
}
        </div>
