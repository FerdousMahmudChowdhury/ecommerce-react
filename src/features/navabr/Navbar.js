                                        ...
                                        <div className="ml-4 flex items-center md:ml-6">
                                           <Link to={'cart'}> <button
                                            ...
                                            >
                                               ...
                                               {items.length>0 &&  <span className="inline-flex items-center rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10 mb-5 -ml-3 z-10">
                                                    {items.length}
                                                </span>}
                            ...
                            <Disclosure.Panel className="md:hidden">
                                ...
                                <div className="border-t border-gray-700 pb-3 pt-4">
                                    <div className="flex items-center px-5">
                                       ...
                                       {items.length>0 && <span className="inline-flex items-center rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10 mb-7 -ml-3 z-10">
                                        {items.length}
