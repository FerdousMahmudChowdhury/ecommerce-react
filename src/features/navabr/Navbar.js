                                        ...
                                        <div className="ml-4 flex items-center md:ml-6">
                                           <Link to={'cart'}> <button
                                            ...
                                            >
                                                ...
                                                <span className="inline-flex items-center rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10 mb-5 -ml-3 z-10">
                                                    3
                                                </span>
